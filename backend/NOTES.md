...
The live run resolves the Phase 0 questions and identifies these contract or plan mismatches. The Hermes source and captured fixtures are authoritative. The planning documents (`SPEC.md` §4/§7, `PLAN_HERMES_SETUP.md` Steps 1/3/4, `PLAN_BACKEND.md` facts + Phase 0/1) were updated 2026-08-13 to reflect every mismatch below.
